...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{sections/1_libri/1_libri}
\input{sections/2_databases/2_databases}
\input{sections/3_dbSystemArchitecture/3_dbSystemArchitecture}
\input{sections/4_dataModelingER/4_dataModelingER}
\input{sections/5_eer/5_eer}
\input{sections/6_sql/6_sql}
\input{sections/7_ddbms/7_ddbms.tex}
\input{sections/8_transaction/8_transaction.tex}
\input{sections/9_nosql/9_nosql.tex}
