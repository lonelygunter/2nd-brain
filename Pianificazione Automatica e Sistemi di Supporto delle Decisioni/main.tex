...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{sections/1_definizioni/1_definizioni.tex}
\input{sections/2_softwareSolution/2_softwareSolution.tex}
\input{sections/3_ottimizzazione/3_ottimizzazione.tex}
\input{sections/4_formulazioniProgLineare/4_formulazioniProgLineare.tex}
\input{sections/5_optimizationModelsReview/5_optimizationModelsReview.tex}
\input{sections/6_branchAndBound/6_branchAndBound.tex}
\input{sections/7_constructiveHeuristics/7_constructiveHeuristics.tex}
