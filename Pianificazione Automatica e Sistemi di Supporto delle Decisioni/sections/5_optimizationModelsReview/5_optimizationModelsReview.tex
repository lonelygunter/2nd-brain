...
Dato che $\rho = 0$, la soluzione ottima di ($P_a$) è ammissibile per ($P$). Eliminiamo la colonna di $\alpha_1$ e risciviamo la f.o. originale:
...
si porta in forma canonica f.o. portanto a $0$ il valore di $x_2$ della f.o.:
