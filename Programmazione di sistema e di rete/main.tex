...
\input{sections/1_comandi/1_comandi}
\input{sections/2_intro/2_intro}
\input{sections/3_systemCall/3_systemCall}
\input{sections/4_standard/4_standard}
\input{sections/5_fileio/5_fileio}
\input{sections/6_fileAndDirectory/6_fileAndDirectory}
\input{sections/7_systemDataFiles/7_systemDataFiles}
