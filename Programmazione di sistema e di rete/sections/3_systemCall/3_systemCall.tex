...
\end{lstlisting}
		...
		dove vediamo che se la variabile "__DARWIN_64_BIT_INO_T
" è stata definita avremo che la struttura di struct dirent è:
...
\end{lstlisting}
	...
	\item \hl{if}: esegue un controllo sugli args. Notiamo che "err_quit" non è una funzione di sistema da:
